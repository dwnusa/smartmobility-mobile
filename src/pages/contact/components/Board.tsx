...
function Board() {
  ...
  // }, []);
  // useEffect(() => {}, []);
  const policyContent = `개인정보의 처리목적\n('www.smartmobilityinc.co.kr'이하 '(주)스마트모빌러티')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
  ...
  return (
    <div className="board">
      ...
      <div className="board-grid">
        ...
        <div className="board-name content"><input placeholder="홍길동"/></div>
        <div className="board-contact title">연락처</div>
        <div className="board-contact content"><input placeholder="010-0000-0000"/></div>
        <div className="board-email title">메일주소</div>
        <div className="board-email content"><input placeholder="abcd@smobility.com"/></div>
