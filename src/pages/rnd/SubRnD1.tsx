...
function SubRnD1({ match, history, isPc }: { match: any; history: any; isPc: boolean }) {
  ...
  const SubRnD1_Pc = ({ match, history, isPc }: { match: any; history: any; isPc: boolean }) => {
    return (
      <React.Fragment>
        <Header2 />
  ...
  const SubRnD1_Mobile = ({ match, history, isPc }: { match: any; history: any; isPc: boolean }) => {
    return (
      <div>Hello!</div>
    )
  }
