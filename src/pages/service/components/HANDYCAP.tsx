...
function HANDYCAP({ currentSlide }: { currentSlide: number }) {
  return (
    <React.Fragment>
      ...
      {currentSlide === 3 && <div className="handycap page3" style={{backgroundImage:`url(${cards.handycap03_1})`}}>
        <div className="handycap-textbox">
          <div>효율적이고 빠르게</div>
          <div>승강기형 출구 알림</div>
          <div>장애인 편의시설 접근과 환승이 가장 편리한 경로를 탐색하여 나에게 맞는 경로를 선택할 수 있습니다.</div>
      ...
      {currentSlide === 4 && <div className="handycap page4" style={{backgroundImage:`url(${cards.handycap04_1})`}}>
        <div className="handycap-textbox">
